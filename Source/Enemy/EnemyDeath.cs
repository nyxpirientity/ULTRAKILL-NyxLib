...
{   
    ...
    static class EnemyIdentifierInstakill
    {
        public static void Prefix(EnemyIdentifier __instance)
        {
            ...
            enemy.NullInvalid()?.TryCallPreDeath(true, typeof(EnemyIdentifierInstakill));
        }
        
        public static void Postfix(EnemyIdentifier __instance)
        {
            var enemy = __instance.GetComponent<EnemyComponents>();
            enemy.NullInvalid()?.TryCallPostDeath(typeof(EnemyIdentifierInstakill));
        }
    }
    ...
    static class EnemyIdentifierExplodePatch
    {
        ...
        {
            var enemy = __instance.GetComponent<EnemyComponents>();
            enemy.NullInvalid()?.TryCallPreDeath(true, typeof(EnemyIdentifierExplodePatch));
        }
        
        public static void Postfix(EnemyIdentifier __instance)
        {
            var enemy = __instance.GetComponent<EnemyComponents>();
            enemy.NullInvalid()?.TryCallPostDeath(typeof(EnemyIdentifierExplodePatch));
        }
    }
    ...
    static class EidDeathPatch
    {
        ...
        public static void PreDeath(EnemyIdentifier eid, bool instakill, object callerObj)
        {
            ...
            enemy.NullInvalid()?.TryCallPreDeath(instakill, callerObj);
        }

        public static void PostDeath(EnemyIdentifier eid, object callerObj)
        {
            var enemy = eid.GetComponent<EnemyComponents>();
            enemy.NullInvalid()?.TryCallPostDeath(callerObj);
        }

        public static void Prefix(EnemyIdentifier __instance, bool fromExplosion)
        {
            var enemy = __instance.GetComponent<EnemyComponents>();
            enemy.NullInvalid()?.TryCallPreDeath(false, typeof(EidDeathPatch));
        ...
        {
            var enemy = __instance.GetComponent<EnemyComponents>();
            enemy.NullInvalid()?.TryCallPostDeath(typeof(EidDeathPatch));
        }
    }
}